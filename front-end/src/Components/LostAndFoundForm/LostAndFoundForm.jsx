...
const LostAndFoundForm = ({ url }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.title) {
      formErrors.title = "Please provide a valid name.";
      isValid = false;
    }
  ...
  const handleSubmit = (e) => {
    ...
    const storageRef = ref(storage, `LostAndFound/${uniqueFilename}`);
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          axios
            .post(`${url}/submit/lostandfound`, data)
            .then((res) => {
            ...
            .catch((err) => {
              ...
              alert("Error in listing the product");
            });
        });
      }
    );
