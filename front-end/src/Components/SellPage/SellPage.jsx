...
const SellPage = ({ url }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.price) {
      formErrors.price = "Please provide a valid price.";
      isValid = false;
    }
  ...
  const handleSubmit = (e) => {
    ...
    const storageRef = ref(storage, `buyAndsell/${uniqueFilename}`);
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="Electronics" defaults>
                      Electronics
                    </option>
